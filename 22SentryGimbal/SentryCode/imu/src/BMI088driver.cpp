...
//宏定义中值
#define accel_0_offset 50
#define accel_1_offset -120	
#define gyro_0_offset 5	
#define gyro_1_offset 0
#define gyro_2_offset 0			
...
void BMI088_read(fp32 gyro[3], fp32 accel[3], fp32 *temperate)
{
    ...
    accel[2] = bmi088_raw_temp * BMI088_ACCEL_SEN;
		*/
		...
		bmi088_raw_temp = (int16_t)((buf[1]) << 8) | buf[0];
    accel[0] = (bmi088_raw_temp-accel_0_offset) * BMI088_ACCEL_SEN;
    bmi088_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
    accel[1] = (bmi088_raw_temp+accel_1_offset) * BMI088_ACCEL_SEN;
    bmi088_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
    accel[2] = bmi088_raw_temp * BMI088_ACCEL_SEN;
    ...
    if(buf[0] == BMI088_GYRO_CHIP_ID_VALUE)
    {
        ...
        gyro[2] = bmi088_raw_temp * BMI088_GYRO_SEN;
				*/
		bmi088_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
        gyro[0] = (bmi088_raw_temp-gyro_0_offset) * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
        gyro[1] = (bmi088_raw_temp-gyro_1_offset) * BMI088_GYRO_SEN;
        bmi088_raw_temp = (int16_t)((buf[7]) << 8) | buf[6];
        gyro[2] = (bmi088_raw_temp-gyro_2_offset) * BMI088_GYRO_SEN;
    }
