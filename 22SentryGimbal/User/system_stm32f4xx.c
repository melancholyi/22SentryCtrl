...
/************************* PLL Parameters *************************************/
 ...
 //by闫创业修改
 #ifdef USE_RM_Cboard_Crystal_oscillator_12MHz
   #define PLL_M      12
 #endif
 #ifdef USE_RM_Aboard_Crystal_oscillator_12MHz
   #define PLL_M      12
 #endif
  #ifdef USE_SCU_board_Crystal_oscillator_25MHz
   #define PLL_M      25
 #endif
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    while ((RCC->CFGR & (uint32_t)RCC_CFGR_SWS ) != RCC_CFGR_SWS_PLL) temp=0;
    {
    }
  }
  else
